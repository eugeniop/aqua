    ...
    <section className="user-management">
      ...
      <div className="grid user-grid">
        <div className="card user-list">
          ...
          <div className="table-scroll" role="region" aria-label={t('Existing users')}>
            {loading ? (
      ...
      {showAddModal && (
        <Modal
          ...
          actions={(
            <>
              <button type="button" className="secondary" onClick={closeAddModal} disabled={submitting}>
                {t('Cancel')}
              </button>
        ...
        >
          <form id="add-user-form" className="modal-form" onSubmit={handleSubmit}>
            <label>
              {t('Name')}
              <input
                type="text"
